export const FORGE_FLEET_FIREBASE_DEFAULTS = {
  apiKey: "",
  authDomain: "",
  projectId: "",
  storageBucket: "",
...
export function resolveFirebaseConfig() {
  const defaults = FORGE_FLEET_FIREBASE_DEFAULTS;
  return {
    ...
    storageBucket: envOrDefault("VITE_FIREBASE_STORAGE_BUCKET", defaults.storageBucket),
    messagingSenderId: envOrDefault("VITE_FIREBASE_MESSAGING_SENDER_ID", defaults.messagingSenderId),
