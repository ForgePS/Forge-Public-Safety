...
import DefinedPortalShell from "./components/DefinedPortalShell.jsx";
import PortalDashboardPage from "./pages/portals/PortalDashboardPage.jsx";
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/:portalSlug" element={<DefinedPortalLayout />}>
        <Route element={<DefinedPortalShell />}>
          <Route index element={<PortalDashboardPage />} />
          <Route path="*" element={<PlaceholderPage title="Portal module" />} />
        </Route>
      </Route>
